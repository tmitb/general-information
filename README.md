...
- sub-moudle repo must start with the parent module name. For example, a sub module for a home automation must start the `home-automation`. If the sub module name is *SDR HVAC Controller*, the repo name will be `home-automation-sdr-hvac-controller`
